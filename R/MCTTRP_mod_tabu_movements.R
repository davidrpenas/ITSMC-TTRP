...
# comprobar seed 
  ...
  # create mov_list C
  .Call('createMovsList', PACKAGE = "itsmcttrp")
  ...
  while ( counter_not_improve < stop_tabu) {
    ...
    size_mov_list <- .Call('return_size_mov_list', PACKAGE = "itsmcttrp")
    ...
    if (size_mov_list) {
      ...
      if (enter_penalty_loop){
        ...
        .Call('c_eval_movs_pen',  tabulist_data$table_freq, zeta, counter_i, PACKAGE = "itsmcttrp")
...
return_mov_struct<-function(counter_index_order){
  ...
  mov_list <- list()
  mov_list$indexr1 <- .Call('return_mov_list_indexr1', as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$indexr2 <- .Call('return_mov_list_indexr2', as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$client1 <- .Call('return_mov_list_client1', as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$client2 <- .Call('return_mov_list_client2', as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$route1 <-  .Call('return_mov_list_route1' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$route2 <-  .Call('return_mov_list_route2' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$hoppers_truck1 <-  .Call('return_mov_list_hoppers_truck1' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$hoppers_trailer1 <-  .Call('return_mov_list_hoppers_trailer1' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$hoppers_truck2 <-  .Call('return_mov_list_hoppers_truck2' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$hoppers_trailer2 <-  .Call('return_mov_list_hoppers_trailer2' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$root1 <-  .Call('return_mov_list_root1' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$root2 <-  .Call('return_mov_list_root2' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$string1 <- .Call('return_mov_list_string' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$mov_list_cost <- .Call('return_mov_list_cost' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$mov_list_cost_pen <- .Call('return_mov_list_cost_pen' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$mov_list_cost_feas  <- .Call('return_mov_list_cost_feas' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$mov_list_cost_nopen  <- .Call('return_mov_list_cost_nopen' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
  mov_list$opt_reconf  <- .Call('return_mov_list_opt_reconf' , as.integer(counter_index_order), PACKAGE = "itsmcttrp")
...
order_movs<-function(movs, option="cost") {
  ...
  if (option == "cost")  {
    ...
    .Call('order', as.integer(1), PACKAGE = "itsmcttrp")
  ...
  if (option == "cost_pen")  {
    ...
    .Call('order', as.integer(0), PACKAGE = "itsmcttrp")
...
modified_mov_list_using_changed_list <- function (changed_list, movs) {
  ...
  if (length(index_to_delete)) {
    ...
    .Call('delete_elements_using_changed_list', index_to_remain, PACKAGE = "itsmcttrp")
...
modified_mov_list_using_changed_list_new <- function (changed_list) {
  ...
  #print("DELETE")
  .Call('delete_elements_using_changed_list', changed_list, PACKAGE = "itsmcttrp")
...
evaluate_cost_mov_list<-function(input, movs, changed_list, solution, alpha, type_problem) {
  ...
  #.Call("evaluate_cost_mov_list", input, mov_list, changed_list, solution, alpha, PACKAGE = "itsmcttrp")
  ...
  if ((length(movs$mov_list)>0)&&(length(changed_list)>0)) {
    ...
    .Call('c_eval_movs', as.integer(changed_list), cap_routes_vector, input$matriz.distancia,
          ...
          as.integer(0), PACKAGE = "itsmcttrp")
  ...
  if ((size_mov>0)&&(length(changed_list)>0)) {
    ...
    if (type_problem == "MCTTRP"){
      ...
      .Call('c_eval_movs_MCTTRP', as.integer(changed_list), cap_routes_vector, input$matriz.distancia,
            ...
            as.numeric(n_hoppers_truck), as.numeric(n_hoppers_trailer), static_feas, static_cost, alpha,  as.integer(0), PACKAGE = "itsmcttrp")
